...
const AddDoctor = () => {
    ...
    const onSubmitHandler=async(e)=>{
        ...
        try{
            ...
            const {data}=await axios.post(backendUrl+ '/api/admin/add-doctor',formData, /*header(admin token)*/{headers:{aToken}})
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='w-full lg:flex-1 flex-col flex gap-4'>
                            ...
                            <div className='flex-1 flex flex-col gap-1'>
                                ...
                                <input onChange={(e)=>setDegree(e.target.value)} value={degree} className='border rounded px-3 py-2' type="text" placeholder='Education details' required />
                            </div>

                            <div className='flex-1 flex flex-col gap-1'>
                                <p>Address</p>
                                <input onChange={(e)=>setAddress1(e.target.value)} value={address1} className='border rounded px-3 py-2' type="text" placeholder='Enter address1' required />
                                <input onChange={(e)=>setAddress2(e.target.value)} value={address2} className='border rounded px-3 py-2' type="text" placeholder='Enter address2' required />
                            </div>
