...
const DoctorProfile = () => {
    ...
    const {backendUrl,setProfileData,profileData,dToken,getProfileData}=useContext(DoctorContext)
  ...
  return profileData&& (
    <div className=''>
      ...
      <div className='flex flex-col gap-4 m-5'>
        <div className=''>
            {/* bg-primary/80 80 is for transparency */}
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
            ...
            <p className='text-gray-600 font-medium mt-4'>
                Appointment fees: <span className='text-gray-800 '>{currency} {isEdit?<input type='number' onChange={(e)=>setProfileData(prev=>({...prev,fees:e.target.value}))} value={profileData.fees}></input>:profileData.fees}</span>
            </p>
            ...
            <div className='flex gap-2 py-2'>
                ...
                <p className='text-sm'>
                    ...
                    </input>:profileData.address.line1}
                    <br />
                    ...
                    </input>:profileData.address.line2}
                </p>
            </div>
